...
namespace SGBank.Tests
{
    ...
    public class BasicAccountTests
    {
        ...
        [Test]
        public void BasicAccountWithdrawRule(string accountNumber, string name, decimal balance, AccountType accountType, decimal amount, decimal newBalance, bool expectedResult)
        {
